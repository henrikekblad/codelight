...
|---|---|---|
| [**companion/**](companion/README.md) | Python daemon that polls Claude, Codex, and optional company Copilot usage, tracks supported agents, pushes status over WebSocket + D-Bus, and brokers remote control |
